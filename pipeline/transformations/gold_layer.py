...
@dp.materialized_view(
    ...
    comment="Daily aggregated metrics for the number of rides, average distance, average fare, and average speed for each day of the week."
)
def day_of_week_metrics():
    # Aggregate by numeric day of week
    sliver = spark.read.table("biap.default.silver_nyc_taxi_trips").groupBy("pickup_day_of_week").agg(
